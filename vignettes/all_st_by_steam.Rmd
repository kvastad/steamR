...
infoTable <- read.csv("data/Data_brain_example/spatial_data/infoTable.csv", 
                     sep = ";", 
                     fileEncoding = "UTF-8",
                     check.names = FALSE)
...
# Read the count matrix from h5 file
counts <- Read10X_h5(infoTable$samples[1])
...
seurat_clusters$Barcode <- gsub("_1$", "", seurat_clusters$Barcode)  # Remove _1 suffix if present
