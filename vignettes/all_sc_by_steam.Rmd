...
```{r}
# clustered_metacells <- generate_metacell_clusters(se, cluster_anno = "subclass_label", verbose = FALSE)
```

Aggregate and save metacell clusters

```{r}
# meta_cell_seurat_all_sum_with_metadata <- aggregate_metacells(clustered_metacells)
...
seurat_clusters <- read.table("/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/Seurat_objects/seurat_clusters.csv",
                               header = TRUE,
                               sep = ";",
...
se <- readRDS("/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/Seurat_objects/MetaCell_normalized.RDS")
...
OpenTargets_SCZ_Genetic_ <- as.character(t(read.table(file = "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/OpenTargets_gene_sets/Human_OpenTargets_SCZ_Genetic.csv")))
length(OpenTargets_SCZ_Genetic_)

OpenTargets_SCZ_Drugs_ <- as.character(t(read.table(file = "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/OpenTargets_gene_sets/Human_OpenTargets_SCZ_Drugs.csv")))
...
```{r}
window50_rank_list_SCZ_Genetic <- readRDS(file = "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/OpenTargets_windowLists/Human_window50_rank_list_SCZ_Genetic.RDS")
window50_rank_list_SCZ_Drugs <- readRDS(file = "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/OpenTargets_windowLists/Human_window50_rank_list_SCZ_Drugs.RDS")
```
...
# perm.mat_p1000_g50 <- generate_permutation_matrix(
#   se = se,
#   gnum = 50,
#   permutation_nr = 1000,
...
# 
# perm.mat_p1000_g218 <- generate_permutation_matrix(
#   se = se,
#   gnum = 218,
#   permutation_nr = 1000,
#   cluster_anno = "supercluster_term"
...
# 
# perm.mat_p1000_g1315 <- generate_permutation_matrix(
#   se = se,
#   gnum = 1315,
#   permutation_nr = 1000,
#   cluster_anno = "supercluster_term"
...
```{r}
perm_files <- c(
  "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/Permutation_matrices/perm.mat_p10000_g50.RDS",
  "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/Permutation_matrices/perm.mat_p10000_g1315.RDS",
  "/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/Permutation_matrices/perm.mat_p10000_g218.RDS"
)
...
```{r}
window_results_drugs <- window_rank_enrichment_analysis(
    se = se,
    perm.mat.window.data = perm.mat.window50.data,
...
```{r}
DEG_genes <- read.csv("/Users/rasools/sdrive/projects/LTS_Lappalainen/nbis_lappalainen_2405/scripts/data/DEG_output/DE_genes.csv", 
                     stringsAsFactors = FALSE, 
                     sep = ";",
                     header = TRUE)
