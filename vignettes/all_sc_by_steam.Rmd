...
```{r}
clustered_metacells <- generate_metacell_clusters(se, cluster_col = "subclass_label")
```
...
```{r, eval=FALSE}
#Permutation matrixs
# perm.mat_p10000_g50 <- generate_permutation_matrix_parallel(
#   se = se,
#   gnum = 50,
#   permutation_nr = 10000,
#   workers = 10,
#   cluster_col = "supercluster_term"
# )
# 
# saveRDS(perm.mat_p10000_g50, file = "Permutation_matrices/perm.mat_p10000_g50.RDS")
# write.matrix(perm.mat_p10000_g50, file=paste0("Permutation_matrices/perm.mat_p10000_g50.csv"), sep = ";")

# perm.mat_p10000_g218 <- generate_permutation_matrix_parallel(
#   se = se,
#   gnum = 218,
#   permutation_nr = 10000,
#   workers = 10,
...
# )
# 
# saveRDS(perm.mat_p10000_g218, file = "Permutation_matrices/perm.mat_p10000_g218.RDS")
# write.matrix(perm.mat_p10000_g218, file=paste0("Permutation_matrices/perm.mat_p10000_g218.csv"), sep = ";")

# perm.mat_p10000_g1315 <- generate_permutation_matrix_parallel(
#   se = se,
#   gnum = 1315,
#   permutation_nr = 10000,
#   workers = 10,
...
# )
# 
# saveRDS(perm.mat_p10000_g1315, file = "Data_brain_example/Permutation_matrices/perm.mat_p10000_g1315.RDS")
# write.matrix(perm.mat_p10000_g1315, file=paste0("Data_brain_example/Permutation_matrices/perm.mat_p10000_g1315.csv"), sep = ";")
```
...
p.val.mat.d <- SpatialTraitEnrichmentAnalysis(
  ...
  perm.mat.window50.data = perm.mat.window50.data,
  window_rank_list_abr_label = window50_rank_list_SCZ_Drugs,
...
# Extract unique cluster names in the correct order
...
```{r}
DEG_genes <- read_csv2("data/DEG_output/DE_genes.csv")
